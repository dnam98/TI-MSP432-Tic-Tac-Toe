...
bool circular_buffer_test_0(uint16_t size)
{
    ...
    for (i = 0; i < size; i++)
    {
        ...
        return_status = circular_buffer_add(test_buffer, i);
    ...
    if (circular_buffer_full(test_buffer) != true)
    {
        circular_buffer_delete(test_buffer);
        return false;
    }
    ...
    // return the circular buffer to the heap and return false.
    if (circular_buffer_add(test_buffer, 'a') == true)
    {
        circular_buffer_delete(test_buffer);
        return false;
    }
    ...
    // return the circular buffer to the heap and return false
    if (circular_buffer_empty(test_buffer) == false)
    {
        circular_buffer_delete(test_buffer);
        return false;
    }
